...
#define CONFIG_PWM0_0_IO				PUMP_PWM_IO
...
#define CONFIG_CANOPEN_RXPDO_COUNT					5
...
#define CONFIG_CANOPEN_HEARTBEAT_PRODUCER_NODEID2	HCU_NODE_ID
#define CONFIG_CANOPEN_HEARTBEAT_PRODUCER_TIME2		2200
#define CONFIG_CANOPEN_HEARTBEAT_PRODUCER_NODEID3	CCU_NODE_ID
...
#define CONFIG_CANOPEN_RXPDO3_ID					(CANOPEN_TXPDO1_ID + HCU_NODE_ID)
...
#define CONFIG_CANOPEN_RXPDO3_MAPPING1_LEN			CANOPEN_TYPE_LEN(HCU_TOTAL_CURRENT_TYPE)
#define CONFIG_CANOPEN_RXPDO3_MAPPING2_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING2_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING2_LEN			CANOPEN_TYPE_LEN(HCU_IMPLEMENT_TYPE)
#define CONFIG_CANOPEN_RXPDO3_MAPPING3_MAIN_INDEX	ESB_HCU_INDEX_OFFSET + HCU_PRESSURE_INDEX
#define CONFIG_CANOPEN_RXPDO3_MAPPING3_SUB_INDEX	HCU_PRESSURE_SUBINDEX
#define CONFIG_CANOPEN_RXPDO3_MAPPING3_LEN			CANOPEN_TYPE_LEN(HCU_PRESSURE_TYPE)
#define CONFIG_CANOPEN_RXPDO3_MAPPING4_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING4_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING4_LEN			CANOPEN_TYPE_LEN(CANOPEN_UNSIGNED8)
#define CONFIG_CANOPEN_RXPDO3_MAPPING5_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING5_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING5_LEN			CANOPEN_TYPE_LEN(CANOPEN_UNSIGNED8)
#define CONFIG_CANOPEN_RXPDO3_MAPPING6_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING6_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO3_MAPPING6_LEN			CANOPEN_TYPE_LEN(CANOPEN_UNSIGNED8)
#define CONFIG_CANOPEN_RXPDO3_MAPPING7_MAIN_INDEX	ESB_HCU_INDEX_OFFSET + HCU_PRESSURE_INDEX
#define CONFIG_CANOPEN_RXPDO3_MAPPING7_SUB_INDEX	HCU_PRESSURE_SUBINDEX
#define CONFIG_CANOPEN_RXPDO3_MAPPING7_LEN			CANOPEN_TYPE_LEN(HCU_PRESSURE_TYPE)
...
#define CONFIG_CANOPEN_RXPDO4_ID					(CANOPEN_TXPDO3_ID + HCU_NODE_ID)
#define CONFIG_CANOPEN_RXPDO4_TRANSMISSION_TYPE		CANOPEN_PDO_TRANSMISSION_ASYNC
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_MAIN_INDEX	ESB_HCU_INDEX_OFFSET + HCU_WORK_ACTIVE_INDEX
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_SUB_INDEX	HCU_WORK_ACTIVE_SUBINDEX
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_LEN			CANOPEN_TYPE_LEN(HCU_WORK_ACTIVE_TYPE)
...
#define CONFIG_CANOPEN_RXPDO5_ID					(CANOPEN_TXPDO3_ID + CCU_NODE_ID)
#define CONFIG_CANOPEN_RXPDO5_TRANSMISSION_TYPE		CANOPEN_PDO_TRANSMISSION_ASYNC
#define CONFIG_CANOPEN_RXPDO5_MAPPING1_MAIN_INDEX	ESB_CCU_INDEX_OFFSET + CCU_WORK_ACTIVE_INDEX
#define CONFIG_CANOPEN_RXPDO5_MAPPING1_SUB_INDEX	CCU_WORK_ACTIVE_SUBINDEX
#define CONFIG_CANOPEN_RXPDO5_MAPPING1_LEN			CANOPEN_TYPE_LEN(CCU_WORK_ACTIVE_TYPE)
#define CONFIG_CANOPEN_RXPDO5_MAPPING2_MAIN_INDEX	ESB_CCU_INDEX_OFFSET + CCU_DRIVE_ACTIVE_INDEX
#define CONFIG_CANOPEN_RXPDO5_MAPPING2_SUB_INDEX	CCU_DRIVE_ACTIVE_SUBINDEX
#define CONFIG_CANOPEN_RXPDO5_MAPPING2_LEN			CANOPEN_TYPE_LEN(CCU_DRIVE_ACTIVE_TYPE)
...
#define CONFIG_CANOPEN_TXPDO3_ID					(CANOPEN_TXPDO3_ID + ESB_NODE_ID)
...
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_MAIN_INDEX	ESB_RPM_REQ_INDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_SUB_INDEX	ESB_RPM_REQ_SUBINDEX
#define CONFIG_CANOPEN_TXPDO3_MAPPING1_LEN			CANOPEN_TYPE_LEN(ESB_RPM_REQ_TYPE)
...
#define CONFIG_SOLENOID_MAX_CURRENT_DEF				1200
