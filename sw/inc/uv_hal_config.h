...
#define CONFIG_CANOPEN_RXPDO1_MAPPING1_MAIN_INDEX	ESB_FSB_TOTAL_CURRENT_INDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING1_SUB_INDEX	ESB_FSB_TOTAL_CURRENT_SUBINDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING1_LEN			CANOPEN_TYPE_LEN(ESB_FSB_TOTAL_CURRENT_TYPE)
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_MAIN_INDEX	ESB_IGNKEY_INDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_SUB_INDEX	ESB_IGNKEY_SUBINDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_LEN			CANOPEN_TYPE_LEN(ESB_IGNKEY_TYPE)
