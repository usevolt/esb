...
#define CONFIG_CANOPEN_RXPDO_COUNT					4
...
#define CONFIG_CANOPEN_RXPDO4_ID					(CANOPEN_TXPDO2_ID + FSB_NODE_ID)
#define CONFIG_CANOPEN_RXPDO4_TRANSMISSION_TYPE		CANOPEN_PDO_TRANSMISSION_ASYNC
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_MAIN_INDEX	0x5fff
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO4_MAPPING1_LEN			CANOPEN_TYPE_LEN(FSB_FUEL_LEVEL_TYPE)
#define CONFIG_CANOPEN_RXPDO4_MAPPING2_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO4_MAPPING2_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO4_MAPPING2_LEN			CANOPEN_TYPE_LEN(0)
...
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_MAIN_INDEX	0x5FFF
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_SUB_INDEX	0
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_LEN			CANOPEN_TYPE_LEN(FSB_FUEL_LEVEL_TYPE)
#define CONFIG_CANOPEN_TXPDO1_MAPPING2_MAIN_INDEX	ESB_OIL_LEVEL_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING2_SUB_INDEX	ESB_OIL_LEVEL_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING2_LEN			CANOPEN_TYPE_LEN(ESB_OIL_LEVEL_TYPE)
#define CONFIG_CANOPEN_TXPDO1_MAPPING3_MAIN_INDEX	ESB_OIL_TEMP_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING3_SUB_INDEX	ESB_OIL_TEMP_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING3_LEN			CANOPEN_TYPE_LEN(ESB_OIL_TEMP_TYPE)
#define CONFIG_CANOPEN_TXPDO1_MAPPING4_MAIN_INDEX	ESB_MOTOR_TEMP_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING4_SUB_INDEX	ESB_MOTOR_TEMP_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING4_LEN			CANOPEN_TYPE_LEN(ESB_OIL_TEMP_TYPE)
#define CONFIG_CANOPEN_TXPDO1_MAPPING5_MAIN_INDEX	ESB_RPM_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING5_SUB_INDEX	ESB_RPM_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING5_LEN			CANOPEN_TYPE_LEN(ESB_RPM_TYPE)
#define CONFIG_CANOPEN_TXPDO1_MAPPING6_MAIN_INDEX	ESB_VDD_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING6_SUB_INDEX	ESB_VDD_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING6_LEN			CANOPEN_TYPE_LEN(ESB_VDD_TYPE)
...
#define CONFIG_CANOPEN_TXPDO2_MAPPING1_MAIN_INDEX	ESB_GLOW_STATUS_INDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING1_SUB_INDEX	ESB_GLOW_STATUS_SUBINDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING1_LEN			CANOPEN_TYPE_LEN(ESB_GLOW_STATUS_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING2_MAIN_INDEX	ESB_STARTER_STATUS_INDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING2_SUB_INDEX	ESB_STARTER_STATUS_SUBINDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING2_LEN			CANOPEN_TYPE_LEN(ESB_STARTER_STATUS_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING3_MAIN_INDEX	ESB_MOTOR_WATER_TEMP_INDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING3_SUB_INDEX	ESB_MOTOR_WATER_TEMP_SUBINDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING3_LEN			CANOPEN_TYPE_LEN(ESB_MOTOR_WATER_TEMP_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING4_MAIN_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING4_SUB_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING4_LEN			CANOPEN_TYPE_LEN(ESB_MOTOR_WATER_TEMP_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING5_MAIN_INDEX	ESB_MOTOR_OIL_PRESS_INDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING5_SUB_INDEX	ESB_MOTOR_OIL_PRESS_SUBINDEX
#define CONFIG_CANOPEN_TXPDO2_MAPPING5_LEN			CANOPEN_TYPE_LEN(ESB_MOTOR_OIL_PRESS_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING6_MAIN_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING6_SUB_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING6_LEN			CANOPEN_TYPE_LEN(ESB_MOTOR_OIL_PRESS_TYPE)
#define CONFIG_CANOPEN_TXPDO2_MAPPING7_MAIN_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING7_SUB_INDEX	0
#define CONFIG_CANOPEN_TXPDO2_MAPPING7_LEN			CANOPEN_TYPE_LEN(ESB_MOTOR_OIL_PRESS_TYPE)
